...
export default function HeaderSettingsDrawer({
  isOpen,
  onClose,
  layoutSettings,
  updateSettingField,
                ...
                >
                  ...
                  >
                    <span
                      style={{
                        color:
                          layoutSettings.headerSettings?.textColor || "#ffffff",
            ...
            <div className="flex-1 overflow-y-auto px-5 pt-1 pb-6 space-y-4 no-scrollbar">
              ...
              >
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    updateSettingField("headerSettings", "text", e.target.value)
                  }
                ...
                >
                  ...
                  <div className="flex gap-1.5 bg-slate-200/50 p-1 rounded-xl">
                    {[
                      ...
                      const isActive =
                        layoutSettings.headerSettings?.align === alignOpt.val;
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          updateSettingField("headerSettings", field, !active)
                        }
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          updateSettingField("headerSettings", "bgColor", color)
                        }
