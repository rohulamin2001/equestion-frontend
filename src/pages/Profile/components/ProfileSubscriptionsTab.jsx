...
export default function ProfileSubscriptionsTab({ profile }) {
  ...
  return (
    <div className="bg-white p-4 sm:p-6 md:p-8 rounded-2xl border border-slate-100 shadow-sm space-y-4 sm:space-y-6">
      <div>
        ...
        <p className="text-[11px] sm:text-xs text-slate-400 text-left mb-4 sm:mb-6 font-bengali">
          আপনার অ্যাকাউন্টে সক্রিয় সাবস্ক্রিপশন এবং বিষয়ভিত্তিক লাইসেন্সসমূহের
          তালিকা
        </p>
      </div>
