...
export default function Support() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">যোগাযোগ ও সাপোর্ট</h1>
        <p className="text-sm text-slate-500">আপনার কোনো সমস্যা বা ফিডব্যাকের জন্য আমাদের সাথে যোগাযোগ করুন</p>
      </div>
