...
const ModalCancelButton = React.forwardRef(({ className, children, ...props }, ref) => (
  <RippleButton
    ref={ref}
    variant="outline"
    className={cn(
...
const ModalSubmitButton = React.forwardRef(({ className, children, ...props }, ref) => (
  <RippleButton
    ref={ref}
    className={cn(
...
export { Button, buttonVariants, ModalCancelButton, ModalSubmitButton }
